...
Run `ruql questionfile.rb Sinatra --template=template.html.erb`
...
+ _/config/_ : folder with all the data generated from the Sinatra renderer that will be used by the Sinatra application.
